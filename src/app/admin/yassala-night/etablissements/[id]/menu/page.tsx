    ...
    <div style={{ minHeight: "100vh", background: BG, color: "#f0eeff", fontFamily: "'Inter',sans-serif" }}>
      ...
      {showImport && (
        <div
          ...
          <div style={{
            width: "100%", maxWidth: 600, background: "#0c0918",
            ...
            <div style={{ padding: "18px 22px 14px", borderBottom: `1px solid ${BORDER_DIM}`, flexShrink: 0 }}>
              ...
              <input
                ...
                style={{ width: "100%", background: "#080514", border: `1px solid ${BORDER_DIM}`, borderRadius: 8, padding: "9px 13px", color: "#f0eeff", fontSize: ".88rem", boxSizing: "border-box" }}
              />
