    ...
    <div style={{ minHeight: "100vh", background: BG, color: "#f0eeff", fontFamily: "'Inter',sans-serif" }}>
      ...
      <div style={{
        ...
        <div style={{ marginLeft: "auto", display: "flex", gap: 8 }}>
          <a href={`/admin/yassala-day/etablissements/${etabId}`}
            style={{ ...MONO, fontSize: ".72rem", color: "#7a7490", textDecoration: "none", padding: "6px 13px", border: `1px solid ${BORDER_DIM}`, borderRadius: 6 }}>
            ⚙ OPTIONS
          </a>
          <a href="/"
